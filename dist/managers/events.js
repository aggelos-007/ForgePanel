...
(function (OpCodes) {
    ...
    OpCodes[OpCodes["CreateCommand"] = 7] = "CreateCommand";
    OpCodes[OpCodes["EditCommand"] = 8] = "EditCommand";
    OpCodes[OpCodes["DeleteCommand"] = 9] = "DeleteCommand";
    OpCodes[OpCodes["DisableCommand"] = 10] = "DisableCommand";
    OpCodes[OpCodes["EnableCommand"] = 11] = "EnableCommand";
    OpCodes[OpCodes["MoveCommand"] = 12] = "MoveCommand";
